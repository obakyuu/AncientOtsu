...
<div class="uk-container uk-margin-large<?= $style[0] ?> uk-animation-fade">
    ...
    <div class="uk-margin-small-top">
        <h2 class="uk-margin-remove">山田古墳群</h2>
        <h5 class="uk-margin-remove">やまだこふんぐん</h5>
    </div>
        ...
        <li class="uk-animation-fade">
            <div class="uk-child-width-expand">
                <iframe uk-height-viewport="offset: true"
                        src="https://www.google.com/maps/d/embed?mid=1wZDWW6BIgcIG7JGDdRxUQsrT13CNcnYh&z=18"></iframe>
            </div>
            <h3>近隣の史跡</h3>
            <ul>
                <li>準備中</li>
