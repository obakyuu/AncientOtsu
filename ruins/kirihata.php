...
<div class="uk-container uk-margin-large<?= $style[0] ?> uk-animation-fade">
    ...
    <div class="uk-margin-small-top">
        <h2 class="uk-margin-remove">桐畑（熊ヶ谷）古墳群</h2>
        <h5 class="uk-margin-remove">きりはた（くまがや）こふんぐん</h5>
    </div>
    ...
    <ul class="uk-switcher uk-margin-medium">
        ...
        <li class="uk-animation-fade">
            <div class="uk-child-width-expand">
                <iframe uk-height-viewport="offset: true" src="https://www.google.com/maps/d/embed?mid=1H7uNjdrMxeaHuVz3g-hb2O2VoGzn2fm5&z=18"></iframe>
            </div>
            <h3>近隣の史跡</h3>
            <ul>
                <li>準備中</li>
