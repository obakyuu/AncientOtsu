...
<div class="uk-container uk-section uk-animation-fade<?= $style[0] ?>">
    ...
    <div class="uk-text-right">令和2年9月5日</div>
    <hr class="uk-divider-icon">
    <h3 class="uk-heading-bullet">はじめに</h3>
    <p>
        当サイトを開設してからおよそ5か月近くが経過しました。開設当時は今ほど多くの機能はなく、コンテンツも全くなく非常に簡素なものでした。
        開設してからは、開設前と変わらず開発に打ち込み、ユーザビリティの向上をはじめ、セキュリティ面の見直し、高いレスポンス性、コンテンツの拡充を意識して
        開発を行ってまいりました。
    </p>
    <h3 class="uk-heading-bullet">言い訳</h3>
    <p>
        5カ月近く掛かってもなお、未だ史跡掲載数が3つだけなのは申し訳ありません。後に口述はしますが、当サイトは私含め関係者一同の
    ...
    <table class="uk-table uk-table-responsive uk-table-divider uk-table-striped uk-table-hover">
        ...
        <tr>
            ...
            <td>12月中</td>
            <td>
                現在公開している全てのページを対象にPHPフレームワークで有名なLaravelフレームワークを導入予定。
                ただ、Laravelについては熟知していないため、開発が難航する可能性があるが高い。<br>
                しかし、導入が成功した場合、当サイトの開発効率が向上することが期待される。恩恵は大きい。
            </td>
        </tr>
        <tr>
            <td>OneSignal</td>
            <td>未定</td>
            <td>
                ServiceWorkerを過去、導入する予定だったが失敗したため、せめてトピックの追加時には
                プッシュ通知をしたいと考え、OneSignalサービスの活用を予定している。<br>
                導入すると、プッシュ通知を受け取れるようになる。当サイトの開発完了時にこの機能は停止予定。
            </td>
        </tr>
        <tr>
            <td>トップページの変更</td>
